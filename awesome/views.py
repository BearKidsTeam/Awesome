...
def thread_detail(request, pk):
	...
	page = [{'title': 'Awesome', 'url': reverse('home_page')}, {'title': 'Recommands', 'url': reverse('thread_list')}, {'title': 'Detail', 'url': '#'}]
...
def tag_id(request, pk):
	...
	page = [{'title': 'Awesome', 'url': reverse('home_page')}, {'title': 'Tags', 'url': reverse('tag_list')}, {'title': 'Apps', 'url': reverse('tag_id', kwargs={'pk':pk})}]
